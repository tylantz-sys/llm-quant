...
for slug in ["gld-regime-starter-v3", "gld-regime-starter-v4", "gld-regime-starter-v5"]:
    spec_path = Path(f"data/strategies/{slug}/research-spec.yaml")
